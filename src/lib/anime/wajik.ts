...
export async function fetchWajikEpisodeDetail(episodeId: string) {
  try {
    ...
    // High-speed direct stream URL: VidSrc HD (bypasses ISP block with 100% uptime)
            ...
            qualityList: [
              {
                ...
                serverList: [
                  ...
                  { title: 'Server 5 (2Embed HD)', serverId: `2embed-${tmdbId}-${season}-${episode}` },
                ]
              }
            ]
          }
